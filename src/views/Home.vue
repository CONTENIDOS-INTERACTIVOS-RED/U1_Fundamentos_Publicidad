        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              p.home-main-title.bg Fundamentos de Publicidad 
              h1.home-title.mb-4 {{ globalData.tituloUnidad }}
              p.descripcion.mb-4 La publicidad es una herramienta estratégica y esencial dentro del ámbito del <em>marketing</em> moderno, cuyo propósito principal es conectar a las marcas con su público objetivo. A lo largo de esta unidad, se explorarán los conceptos claves de la publicidad, sus características y su impacto en el entorno económico y digital actual. Se estudiará cómo la comunicación efectiva, la creatividad y la personalización de los mensajes, permiten a las empresas posicionarse en un mercado cada vez más competitivo y dinámico.
              
              p #[b ¡Prepárate para descubrir cómo la publicidad conecta marcas y emociones en un mundo globalizado!]
